...
`main` の URL は最新版を指します。再現可能な導入には、固定タグ `v1.5.0` の URL を
使ってください。

```text
https://github.com/runceel/github-copilot-app-presentation/tree/v1.5.0/.github/extensions/presentation
```

## 最新リリース

現在の presentation canvas の最新版は **v1.5.0** です。

- [v1.5.0 リリース](https://github.com/runceel/github-copilot-app-presentation/releases/tag/v1.5.0)
- [固定タグから Extension を導入](https://github.com/runceel/github-copilot-app-presentation/tree/v1.5.0/.github/extensions/presentation)
