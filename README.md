...
scope. To install the current **[v2.1.1 release](https://github.com/runceel/markdstage/releases/tag/v2.1.1)**
...
>
> `https://github.com/runceel/markdstage/tree/v2.1.1/.github/extensions/markdstage`
...
The current **[v2.1.1 release](https://github.com/runceel/markdstage/releases/tag/v2.1.1)**
includes portable builds and SHA-256 checksum files for Windows x64 and ARM64:

- [MarkdStage-win-x64.zip](https://github.com/runceel/markdstage/releases/download/v2.1.1/MarkdStage-win-x64.zip)
- [MarkdStage-win-arm64.zip](https://github.com/runceel/markdstage/releases/download/v2.1.1/MarkdStage-win-arm64.zip)
