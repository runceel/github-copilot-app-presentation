...
scope. To install the current **[v3.2.0 release](https://github.com/runceel/markdstage/releases/tag/v3.2.0)**
...
The current **[v3.2.0 release](https://github.com/runceel/markdstage/releases/tag/v3.2.0)**
