...
- 「`slides.md` に従ってプレゼンしてください」「@sample.md を MS っぽくプレゼンしてください」のように、**Markdown ファイルを指定してプレゼンを依頼されたら `presentation` スキル**を使ってください。
- スライドの内容は Markdown ファイル（例: `slides.md`、`sample.md`）に記述します。`---` の行がスライドの区切りです。
